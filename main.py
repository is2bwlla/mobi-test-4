...
import os
from pdf_extractor_anfavea import process_pdf_and_generate_prompts_anfavea
from pdf_extractor_fenabrave import processar_resumo_mensal #, process_pdf_and_generate_prompts_fenabrave
...
#     pdf_filename = "2025_01_02.pdf"
#     pdf_path = os.path.join(os.path.dirname(__file__), "pdf", pdf_filename)
#     # process_pdf_and_generate_prompts_anfavea(pdf_path)
#     process_pdf_and_generate_prompts_fenabrave(pdf_path)
